            ...
            <div class="outter-wp">
                ...
                <div class="candile">
                    ...
                    <div class="candile-inner">
                        ...
                        <center><h3 style="font-family:'Copperplate Gothic Light';color:black;font-size:40px;">PBSA Users</h3></center>
                        <hr id="hr">
                                ...
                                <section class="contact-section">
                                    <div class="container">
                                        ...
                                        <div class="col-md-12"><table id="example" class="display" cellspacing="0" >
                                                ...
                                                $result = $objEmployee->getApprovedUsers();
                                                if($result->num_rows > 0)
                                                {
                                                    ...
                                                    {
                                                        if($row["role"] == Constants::rolePrincipal)
                                                        {
                                                            $department = "---";
                                                        }
                                                        else
                                                        {
                                                            $department = $objDep->getDepartmentName($row["department"]);
                                                        }
                                                        $status = "";
                                                        if($row["is_active"] == 1)
                                                        {
                                                            $status = "Active";
                                                            $style = "class=\"font-red\"";
                                                        }
                                                        ...
                                                        echo '<tr>
                                                                    ...
                                                                    <td> <form method="post" action="../../controllers/admin/ChangeEmployeeStatus.php"><input name="e_id" value="'.$row["e_id"].'" hidden readonly><input name="status" value="'.$row["is_active"].'" hidden readonly> <button name="changeStatus" class="btn btn-primary">Change Status</button></form> </td>
                                                                  </tr>';
                                                    }
