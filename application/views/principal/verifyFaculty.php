...
//                                                        ?>
                                                        <tr>
                                                            ...
                                                            <td> <form method="post" action="verify1.php?dept=<?php //echo $dbname; ?>" ><button name="approve[<?php //echo $i?>]" id="app" class="btn btn-primary" value='<?php  // echo $dbname; ?>'>View</button></form> </td>
                                                        </tr>
                                                        <?php
//                                                        $i++;
//                                                    }
