                ...
                <div class="candile">
                    <div class="candile-inner">
                        ...
                        <div id="center"><div id="fig">
                                ...
                                <br> <br>
                                <form action="verifyFaculty.php" method="post">


                                    <button id="bt" class="button">Verify Faculty PBSA &nbsp;<i class="fa fa-angle-double-right fa-lg"></i></button>

                                    <br> <br>
                                </form>
                                <form action="verifyHod.php" method="post">


                                    <button id="btx" class="button">&nbsp;&nbsp;Verify Hod PBSA &nbsp;<i class="fa fa-angle-double-right fa-lg"></i>&nbsp;</button>
