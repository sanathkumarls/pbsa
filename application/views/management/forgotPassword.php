...
<div id="my-modal" class="a">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="post" action="../../controllers/management/ManagementForgotPasswordController.php" >
                <div class="form-group"> <label for="exampleInputPassword1">Email Address</label> <br> <br>
                    <input type="text" autocomplete="off" name="email" class="form-control" placeholder="E-mail" required="" > </div>
