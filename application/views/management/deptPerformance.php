                            ...
                            <div class="container">
                                ...
                                <div class="col-md-12"><table id="example" class="display" cellspacing="0" >
                                        ...
                                        if($result->num_rows > 0)
                                        {
                                            ...
                                            <tr>
                                            <td>'.++$i.'</td>
                                            <td title="'.$row["d_name"].'">'.$row["d_abbr"].'</td>

                                            <td><form method="post" action="performanceYear.php"><input name="d_id" value="'.$row["d_id"].'" readonly hidden><button name="view" class="btn btn-new btn-primary">Year View</button></form><form action="performance.php" method="post"><input name="d_id" value="'.$row["d_id"].'" hidden readonly><button name="view" class="btn btn-primary">View</button></form> </td>
                                            </tr>';
                                            }
