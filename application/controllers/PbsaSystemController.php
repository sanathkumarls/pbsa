...
class PbsaSystemController
{
        function getUserInput($year)
        {
            ...
            $result = $objPbsaModel->getPbsa($e_id,$year);
            if($result)
            {
            ...
            if(!empty($_FILES['c11_path']['name']))
            {
                ...
                if (($size > 5242880))
                {
                    ...
                    echo '<script type="text/javascript">alert("'.$message.'");window.location.href="../views/index.php";</script>';
                }
                ...
                else
                {
                    ...
                    $c11_path = $row['year']."-c11-".$row['e_id'];

                    move_uploaded_file($_FILES['c11_path']['tmp_name'],__DIR__.'/../../uploads/faculty/documents/'.$c11_path.".".$extention);
                    $c11_path="uploads/faculty/documents/".$c11_path.".".$extention;
                }
            }
            $objC1 = new C1();
