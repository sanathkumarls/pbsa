...
{
    $objHodEdit = new HodEditProfile();
    $objHodEdit->getInput();
}

class HodEditProfile
{
    public function getInput()
    {
        ...
        if(!empty($_FILES['photo']['name']))
        {
            ...
            if (($size > 5242880))
            {
                ...
                echo '<script type="text/javascript">alert("'.$message.'");window.location.href="../../views/hod/editProfile.php";</script>';
            }
            ...
            else
            {
                ...
                move_uploaded_file($_FILES['photo']['tmp_name'],__DIR__.'/../../../uploads/hod/profile/'.$img.".".$extention);
                $photo="uploads/hod/profile/".$img.".".$extention;
            }
        }
        ...
        else
        {
            echo "<script>alert('Fill All Fields.');
                window.location.href='../../views/hod/editProfile.php';</script>";
        }
    }
    ...
    function employeeProfileEdit($initial,$firstName,$lastName,$email,$dob,$doj,$phone,$photo)
    {
        ...
        if($user)
        {
            echo "<script>alert('Updated Successfully'); window.location.href='../../views/hod/home.php';</script>";
