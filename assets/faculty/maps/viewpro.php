...
<div class="col-md-6 tini-time-line1">
														 <h3 class="sub-tittle">Best Employee of each department </h3>
															<ul class="timeline">
															<?php 
...
?>
																<li>
																  <div class="timeline-badge info"><?php echo $i;?></div>
																  <div class="timeline-panel">
																	<div class="timeline-heading">
																	  <h4 class="timeline-title">Department :</h4>
																	</div>
